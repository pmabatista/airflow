...
with DAG(
    ...
    t1 = BashOperator(
        task_id='etl_atendimentos_upa_samambaia',
        bash_command="""
        cd $AIRFLOW_HOME/dags/etl_scripts
        python3 etl_atendimentos.py 12 131.72.222.93 1157 10.233.95.80 dicomvix system98 5421 clinux_upa system98 1 limpar
    """)
    t2 = BashOperator(
        task_id='etl_exames_upa_samambaia',
        bash_command="""
        cd $AIRFLOW_HOME/dags/etl_scripts
        python3 etl_exames.py 12 131.72.222.93 1157 10.233.95.80 dicomvix system98 5421 clinux_upa system98 1 limpar
    """)
    t3 = BashOperator(
        task_id='etl_pacientes_upa_samambaia',
        bash_command="""
        cd $AIRFLOW_HOME/dags/etl_scripts
        python3 etl_pacientes.py 12 131.72.222.93 1157 10.233.95.80 dicomvix system98 5421 clinux_upa system98 1 limpar
    """)
