...
with DAG(
    ...
    t1 = BashOperator(
        task_id='etl_atendimentos_hmo',
        bash_command="""
        cd $AIRFLOW_HOME/dags/etl_scripts
        python3 etl_atendimentos.py 20 54.233.89.203 22 localhost dicomvix Gtecgyn@2019 5431 clinux_crd system98 22 limpar
    """)
    t2 = BashOperator(
        task_id='etl_exames_hmo',
        bash_command="""
        cd $AIRFLOW_HOME/dags/etl_scripts
        python3 etl_exames.py 20 54.233.89.203 22 localhost dicomvix Gtecgyn@2019 5431 clinux_crd system98 22 limpar
    """)
    t3 = BashOperator(
        task_id='etl_pacientes_hmo',
        bash_command="""
        cd $AIRFLOW_HOME/dags/etl_scripts
        python3 etl_pacientes.py 20 54.233.89.203 22 localhost dicomvix Gtecgyn@2019 5431 clinux_crd system98 22 limpar
    """)
