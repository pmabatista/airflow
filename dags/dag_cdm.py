...
with DAG(
    ...
    t1 = BashOperator(
        ...
        python3 etl_atendimentos.py 1 186.251.74.20 22 localhost dicomvix system98 5422 clinux_caldas_novas system98 3 limpar
    """)
    t2 = BashOperator(
        task_id='etl_exames_cdm',
        bash_command="""
        cd $AIRFLOW_HOME/dags/etl_scripts
        python3 etl_exames.py 1 186.251.74.20 22 localhost dicomvix system98 5422 clinux_caldas_novas system98 3 limpar
    """)
    t3 = BashOperator(
        task_id='etl_pacientes_cdm',
        bash_command="""
        cd $AIRFLOW_HOME/dags/etl_scripts
        python3 etl_pacientes.py 1 186.251.74.20 22 localhost dicomvix system98 5422 clinux_caldas_novas system98 3 limpar
    """)
    t4 = BashOperator(
